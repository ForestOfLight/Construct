...
#21: Diagonal faces are modeled incorrectly in many cases. Example blocks: lecturn, tripwire hook, lever, horizontal chain. Crosses like for flowers, grass, and lanterns are working correctly. The textures look to be correct in all cases.
