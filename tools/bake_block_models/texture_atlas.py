...
from tints import DEFAULT_TINTS
...
# model_resolver.resolve_elements). A composite is layers drawn in order,
...
# face_reduction.merge_coincident_faces). An explicit tint is one the block's
