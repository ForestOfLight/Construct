...
from b2j_fixups import corrected_java_state
from block_entity_models import resolve_block_entity
from blockstate_resolver import resolve_java_state
from face_geometry import billboard_roll, face_size
from face_reduction import (
    cull_interior_faces,
    join_coplanar_faces,
    merge_coincident_faces,
)
from stand_in_shapes import WHITE_CUBE_FACES, stand_in_cube
from texture_atlas import flipped, tinted
from tints import state_tint
...
def build_block_models(mcmeta, b2j, atlas, stats=None):
    ...
    accumulates into `stats` (a face_reduction.ReductionStats) if given."""
    block_models = {}
